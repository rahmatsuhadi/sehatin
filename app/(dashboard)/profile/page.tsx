...
export default function ProfilePage() {
  ...
  const handleLogout = () => {
    router.refresh(); // sama seperti location.reload()
  };
    ...
    <div className="page-section fade-in pb-24">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-red-50 text-red-500 font-bold py-4 rounded-2xl mt-4 border border-red-100 hover:bg-red-100 transition"
        >
          Keluar Akun
        </button>
      </div>
